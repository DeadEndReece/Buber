...
BUBER turns BeamNG.drive Career Mode into a ride-share, taxi, and bus route side hustle. Take fares, keep passengers happy, build your driver rating, unlock bigger jobs, and work your way from small local pickups to full city routes.

## What It Does

BUBER adds a Career Mode taxi service with its own UI app, fare offers, passenger types, payout balancing, driver rating, progression unlocks, and optional taxi meter.
...
- Multi-stop and bus route jobs after progression unlocks.
...
For bus or multi-stop work, follow each stop in order. The meter will show the current route state, onboard passengers, next stop, and boarding/drop-off instructions.
...
- Multi-stop and bus route jobs.
- Better earning potential for high-capacity vehicles.
...
| 2.0 | $2,500 | $4,500 | 18 | Multi-stop and bus routes unlock. |
| 2.5 | $3,300 | $6,000 | 25 | Bus payouts and seat capacity increase. |
...
Route fares stay locked until 2.0 driver rating. This keeps buses and high-capacity vehicles from skipping the early progression.
...
- A small car can only serve small groups.
- A van or SUV can serve more passengers as your rating improves.
- A bus can eventually use its full capacity, but only after enough rating progression.

## Bus Routes

Bus routes unlock at 2.0 driver rating. These use BeamNG route/stop data where available and turn the trip into a multi-stop job.
